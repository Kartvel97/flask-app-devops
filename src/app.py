...
def health_page():
    ...
    return render_template('health.html', health=data)
...
def system_info_page():
    ...
    return render_template('system_info.html', system_data=data)
...
if __name__ == "__main__":
    # gunicorn в проде, это только для локального теста
